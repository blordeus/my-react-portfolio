...
+                   ${img}?fm=jpeg&quality=100&ixlib=php-1.3.2&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fHx8fHx8fHx8fHVyZTl8&auto=format&fit=crop&w=1920&h=1080&q=100 2x`}
+          />
+          <img
+            alt={name}
+            className="h-full w-full object-cover hover:scale-110 transition-all ease-out duration-300"
