        ...
        <div className="flex gap-3 mt-4">
          ...
          {showSource && (
            <button
              ...
              className="px-4 py-2.5 border-2 border-gray-300 text-gray-700 rounded-lg font-medium hover:border-blue-600 hover:text-blue-600 transition-colors duration-200"
            >
