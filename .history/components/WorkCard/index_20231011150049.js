...
const WorkCard = ({ img, name, description, onClick, sourceURL, projects }) => {
<<<<<<<<<<<<<  ✨ Codeium AI Suggestion  >>>>>>>>>>>>>>
const handleSourceClick = () => {
-  //TODO: link window open to sourceURL property
-  window.open(sourceURL);
+  window.open(sourceURL); // link window open to sourceURL property
};
<<<<<  bot-5b0654c5-8924-4db5-8145-7a6c8f12daea  >>>>>
