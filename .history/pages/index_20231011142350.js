...
+};
+
+const DemoButton = ({ data }) => {
+  return (
+    <button onClick={() => handleDemoClick(data)}>Demo</button>
+  );
+};
+
+export default DemoButton;
<<<<<  bot-b264e03e-7794-4665-a25f-1296f3a450a7  >>>>>
  ...
  return (
    <div className={`relative ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="container mx-auto mb-10">
        ...
        {/* <div className="mt-10 laptop:mt-30 p-2 laptop:p-0 mt-32">
