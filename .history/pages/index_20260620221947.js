...
const services = [
  {
    ...
    description: "React and Next.js sites that load fast and hold up on mobile. Marketing pages, full-stack apps, and the client portals in between.Translating designs into fast, responsive web experiences — from marketing sites to full-stack applications.",
